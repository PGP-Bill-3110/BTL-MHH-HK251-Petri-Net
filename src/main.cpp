...
int main() {
    ...
    for (size_t i = 0; i < nets.size(); ++i) {
        ...
        // =====================================================================
        // Task 4: Deadlock Detection with ILP and BDD
        // =====================================================================
        ...
        // Tạo deadlock detector với BDD reacher từ Task3
        DeadlockILP deadlockDetector(nets[i], &bddReacher);
        
        cout << "Checking for deadlocks...\n";
        // Tìm deadlock
        bool hasDeadlock = deadlockDetector.findDeadlock();
        
        // ket thuc tinh thoi gian
        auto endTask4 = high_resolution_clock::now();
        duration<double> timeTask4 = endTask4 - startTask4;
        
        // In kết quả chi tiết
        deadlockDetector.printResult();
        
        cout << ">> Task4 Execution Time: " << timeTask4.count() << " seconds.\n";
...
// Compile command:
// g++ -std=c++11 -O2 -I./inc -I./lib -I/usr/local/include src/*.cpp -o pnml_test -L/usr/local/lib -lcudd
// 
// Run:
// ./pnml_test
